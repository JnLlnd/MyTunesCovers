...
global lSettingsPictureSizeReload := "New picture size will only be effective after you reload ~1~.`n`nDo you want to restart ~1~ now?"
global lSettingsPictureSizeReloadTitle := "Picture Size - ~1~"
