...
global lAlphaTestingPrompt := "You are about to use an ALPHA version of ~1~.`n`nEven if this application has been well tested by its developer, you must understand that this is an unfinished product that may not behave as expected. Before using this ALPHA version, make sure you have a recent backup of your library and music data.`n`nBy clicking the I ACCEPT button, I confirm that I understand this warning message."
